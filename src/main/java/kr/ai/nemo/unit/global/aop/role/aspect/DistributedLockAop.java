...
import kr.ai.nemo.unit.global.aop.role.annotation.DistributedLock;
import kr.ai.nemo.unit.global.error.exception.LockAcquisitionFailedException;
import kr.ai.nemo.unit.global.util.AopForTransaction;
import kr.ai.nemo.unit.global.util.CustomSpringELParser;
...
public class DistributedLockAop {
  ...
  @Around("@annotation(kr.ai.nemo.unit.global.aop.role.annotation.DistributedLock)")
